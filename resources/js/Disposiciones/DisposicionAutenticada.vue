            ...
            <nav class="border-b border-gray-100 bg-white">
                    ...
                    <div class="flex h-16 justify-between">
                        <div class="flex">
                            ...
                            <div class="flex shrink-0 items-center">
                                <Link :href="route('dashboard')">
                                    <LogoAplicacion  class="block h-9 w-auto fill-current text-gray-800"/>
                                </Link>
                            </div>

                            <!-- Navigation Links -->
                            <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex" >
                                <EnlaceNavegacion :href="route('dashboard')" :activo="route().current('dashboard')" >
                                    Dashboard
                                </EnlaceNavegacion>
                            </div>
                        </div>
                        ...
                        <div class="hidden sm:ms-6 sm:flex sm:items-center">
                            ...
                            <div class="relative ms-3">
                                <Desplegable align="right" width="48">
                                    <template #trigger>
                                    ...
                                    <template #content>
                                        <DropdownLink :href="route('perfil.edit')">
                                            Profile
                                        </DropdownLink>
                ...
                <div :class="{ block: showingNavigationDropdown, hidden: !showingNavigationDropdown, }" class="sm:hidden">
                    <div class="space-y-1 pb-3 pt-2">
                        <ResponsiveNavLink :href="route('dashboard')" :activo="route().current('dashboard')" >
                            Dashboard
                        </ResponsiveNavLink>
                    </div>
...
import Desplegable from '../Componentes/Desplegable.vue';
import EnlaceNavegacion from '../Componentes/EnlaceNavegacion.vue';
import EnlaceNavegacionResponsivo from '../Componentes/EnlaceNavegacionResponsivo.vue';
