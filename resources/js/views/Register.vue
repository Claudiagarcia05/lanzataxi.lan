  ...
  <div class="min-h-screen bg-neutral-soft flex items-center justify-center px-4">
    <div class="w-full max-w-md bg-white rounded-2xl shadow-lg p-8">
      ...
      <form @submit.prevent="handleRegister" class="space-y-4">
        ...
        <div>
          <label class="block text-sm font-medium text-neutral-slate mb-1">Tel̩fono (opcional)</label>
          <input
            v-model="form.phone"
            type="tel"
            autocomplete="tel"
        ...
        <div>
          <label class="block text-sm font-medium text-neutral-slate mb-1">Confirmar contrase̱a</label>
          <input
