...
<template>
  <AdminLayout>
    <div class="mb-8">
      ...
      <p class="text-neutral-slate">Bienvenido, {{ authStore.usuario?.name }}. AquÃƒÂ­ puedes gestionar toda la plataforma.</p>
    </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
      ...
      <div class="bg-white rounded-xl shadow-sm p-6">
        <h3 class="font-semibold text-neutral-dark mb-4">Acciones rÃƒÂ¡pidas</h3>
        <div class="space-y-3">
        ...
        <div class="space-y-3">
          <div v-for="solicitud in solicitudesPendientes" :key="solicitud.id"
            ...
            <div>
              ...
              <p class="text-xs text-neutral-slate mt-1">Licencia: {{ solicitud.license }} Ã‚Â· SolicitÃƒÂ³: {{ solicitud.appliedAt }}</p>
            </div>
          ...
          <table class="w-full">
            ...
            <tbody>
              <tr v-for="viaje in viajesRecientes" :key="viaje.id" class="border-b border-neutral-volcanic hover:bg-neutral-soft">
                ...
                <td class="p-4 text-sm">{{ viaje.conductorName || 'Ã¢â‚¬â€' }}</td>
                <td class="p-4">
