    ...
    actions: {
        async login(credentials) {
            ...
            try {
                ...
                // â­ Guardar token en cookie para que Laravel lo reconozca (7 dÃ­as)
        ...
        async register(datosUsuario) {
            ...
            try {
                ...
                // Autenticar automÃ¡ticamente despuÃ©s del registro
                this.usuario = usuario
                this.token = token
                localStorage.setItem('token', token)
                localStorage.setItem('usuario', JSON.stringify(usuario))
        ...
        // FunciÃ³n para obtener la ruta del dashboard segÃºn el rol del usuario
        getDashboardRoute() {
